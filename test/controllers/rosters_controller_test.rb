...
class RostersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create roster" do
    assert_difference("Roster.count") do
      post rosters_url, params: { roster: { company_id: @roster.company_id, roster_date: @roster.roster_date } }
    end
  ...
  test "should update roster" do
    patch roster_url(@roster), params: { roster: { company_id: @roster.company_id, roster_date: @roster.roster_date } }
